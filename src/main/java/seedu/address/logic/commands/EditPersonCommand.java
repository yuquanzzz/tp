...
public class EditPersonCommand extends EditCommand {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        ParentName preservedParentName = personToEdit.getParentName().orElse(null);

        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags, preservedParentName);
    }
